...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
	...
	ADD_CUSTOM_TARGET(${_targetname}
		...
		COMMAND ${LCOV_PATH} --directory ${CMAKE_SOURCE_DIR} --capture --output-file ${_outputname}.info --rc lcov_branch_coverage=1
...
#	IF(NOT Python_FOUND)
#		MESSAGE(FATAL_ERROR "Python not found! Yeeting...")
